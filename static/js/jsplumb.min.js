(function () {
            ...
            D = function (a, b, c, d) {
                ...
                this.downListener = function (a) {
                    ...
                    if (b && this.isEnabled() && this.canDrag()) {
                        ...
                        if (d) {
                            if (u)
                                if (s = this.el.cloneNode(!0), this.params.addClass(s, p.clonedDrag), s.setAttribute("id", null), s.style.position = "absolute", null != this.params.parent) {
    ...
    function () {
        ...
        var m = 0,
            ...
            o = a.jsPlumbInstance = function (d) {
                this.version = "2.7.3", d && p.extend(this.Defaults, d), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, b.EventGenerator.apply(this);
                var f = this,
                    g = n(),
                    h = f.bind,
                    j = {},
                                ...
                                if (i = p.extend({}, i), p.isAlreadyDraggable(a, f)) d.force && f.initDraggable(a, i);
                                    ...
                                    sa(e, a), i[l] = b.wrap(i[l], function () {
                                        return f.setHoverSuspended(!0), f.select({
                                            ...
                                            target: a
                                        }).addClass(f.elementDraggingClass + " " + f.targetElementDraggingClass, !0), f.setConnectionBeingDragged(!0), i.canDrag ? d.canDrag() : void 0
                ...
                this.deleteConnection = function (a, c) {
                    return null != a && (c = c || {}, c.force || b.functionChain(!0, !1, [
                        ...
                        [a, ba, [a]],
                        [f, da, [ca, a]]
                    ])) ? (a.setHover(!1), _(a, !a.pending && c.fireEvent !== !1, c.originalEvent), a.endpoints[0].detachFromConnection(a), a.endpoints[1].detachFromConnection(a), b.removeWithFunction(u, function (b) {
                        return a.id === b.id
    ...
    function () {
        ...
        b.Endpoint = function (a) {
            ...
            var l = null;
            this._jsPlumb.uuid && (a.endpointsByUUID[this._jsPlumb.uuid] = this), this.elementId = a.elementId, this.dragProxy = a.dragProxy, this._jsPlumb.connectionCost = a.connectionCost, this._jsPlumb.connectionsDirected = a.connectionsDirected,
            ...
            this.computeMaxSize = function () {
                ...
                if (a.pointAlongPathFrom) {
                    if (c.isString(this.loc) || this.loc > 1 || this.loc < 0) {
                        ...
                        if (j = a.pointOnPath(this.loc), g = a.pointAlongPathFrom(this.loc, this.length),
                            e = d.pointOnLine(j, g, this.length), -1 === f) {
                            var p = j;
                            j = e, e = p
                        }
    ...
    function () {
        ...
        c.extend(A, z), b.Endpoints.svg.Dot = function () {
            ...
            }, c.extend(b.Connectors.svg.StateMachine, [b.Connectors.StateMachine, b.ConnectorRenderers.svg]), b.Endpoints.svg.Image = b.Endpoints.Image, b.Endpoints.svg.Blank = b.Endpoints.Blank, b.Overlays.svg.Label = b.Overlays.Label,
